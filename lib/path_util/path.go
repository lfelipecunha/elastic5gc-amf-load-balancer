...
// GoamfLoadBalancerPath ...
/*
 * Author: Roger Chu aka Sasuke
 *
 * This package is used to locate the root directory of goamfLoadBalancer project
 * Compatible with Windows and Linux
 *
 * Please import "amfLoadBalancer/lib/path_util"
 *
 * Return value:
 * A string value of the relative path between the working directory and the root directory of the goamfLoadBalancer project
 *
 * Usage:
 * path_util.GoamfLoadBalancerPath("your file location starting with goamfLoadBalancer")
 *
 * Example:
 * path_util.GoamfLoadBalancerPath("amfLoadBalancer/abcdef/abcdef.pem")
 */
func GoamfLoadBalancerPath(path string) string {
